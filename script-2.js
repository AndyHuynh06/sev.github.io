  ...
  $.fn.tilt = function (options) {
    ...
    const updateTransforms = function () {
      ...
      if (this.reset) {
        ...
        if (this.settings.glare) {
          this.glareElement.css(
            "transform",
            `rotateX(180deg) translate(-50%, -50%)`
          );
        ...
        if (this.settings.glare) {
          this.glareElement.css(
            "transform",
            `rotateX(${this.transforms.angle}deg) translate(-50%, -50%)`
          );
          this.glareElement.css(
            "opacity",
    ...
    return this.each(function () {
      ...
      if (this.settings.axis !== null) {
        console.warn(
          "Tilt.js: the axis setting has been renamed to disableAxis. See https://freewebsitecode.com/ for more information"
        );
